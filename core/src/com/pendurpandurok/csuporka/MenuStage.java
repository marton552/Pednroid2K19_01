...
public class MenuStage extends MyStage {
    ...
    public MenuStage(Batch batch, MyGame game) {
        ...
        OneSpriteStaticActor actor = new OneSpriteStaticActor(Assets.manager.get(Assets.BADLOGIC_TEXTURE));
        actor.setSize(5, 5);
        //addActor(actor);


        mWorld = new World(new Vector2(-9.2f, 0), false);
        ...
        mParticleDebugRenderer = new ColorParticleRenderer(10000);
    ...
    private void createParticleStuff(float width, float height) {
        ...
        mParticleGroupDef1.flags.add(ParticleDef.ParticleType.b2_powderParticle);
